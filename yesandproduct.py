...
response = client.chat.completions.create(
    ...
    messages=[
        ...
        "role": "user",
        "content": [
            {"text": "Pretend you've NEVER EVER seen this object before, and describe it as if it is a new invention from a toy company. Use only a single sentence to describe it. Do not name it.", "type": "text"},
            {
                "image_url": {"url": open_image_as_base64("images/toy_soundloop.png")},
                "type": "image_url",
            },
        ],
    }],
